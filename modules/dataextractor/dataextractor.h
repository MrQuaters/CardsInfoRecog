...
class DataExtractor {
	...
	bool _geom_restore(cv::Mat&); //find geometrical marker and restores true document position
...
public:
	...
	std::vector<extrdata> data_extract(cv::Mat&, bool t = false);
};
